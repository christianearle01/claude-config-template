...
- [START_HERE.md](../../../START_HERE.md) - 5-minute quick start (80/20 rule)
...
Read START_HERE.md for the full quick guide!"
```
...
"For daily usage, see: START_HERE.md"
```
