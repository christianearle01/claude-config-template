...
/cost
# Compare: cache_read_tokens vs input_tokens ratio
# High cache ratio = good optimization
...
```bash
/cost
# Look at: input_tokens vs cache_read_tokens
```

**If cache_read_tokens is low (<30%):**
- Agents aren't reusing cached content
...
5. **Monitor with /cost** - track cache efficiency
