...
- **[Project Planner Agent Documentation](../../.claude/agents/README.md#-project-planner)** - Full agent capabilities
...
- **[Project Onboarding](../../02_project-onboarding/must-have/01_onboarding-guide.md)** - What to do AFTER planning
